...
insert into public.timelines (slug, owner_id, title, description, category, language, visibility, share_id, start_year, end_year, cover_seed)
values ('personal-moving-history', '00000000-0000-4000-8000-f4a4aa64320d', '引っ越しの歴史', '1955年生まれの私が経験した、社宅から団地、四畳半、持ち家までの引っ越しの記録です。住まいの変遷に家族の節目と日本の住宅史を重ねて、間取りの変化が時代をどう映してきたのかを、落ち着いて振り返ってみます。', 'personal-life', 'ja', 'public', 's_personal-moving-history', 1961, 2021, 'personal-moving-history')
on conflict (slug) do update set owner_id = excluded.owner_id, title = excluded.title, description = excluded.description, category = excluded.category,
  start_year = excluded.start_year, end_year = excluded.end_year, updated_at = now();
...
with ev as (insert into public.events (timeline_id, layer_id, event_date, end_date, date_precision, event_type, title, summary, detail, credibility, credibility_note, origin, position)
  values ((select id from public.timelines where slug = 'personal-moving-history'),
          ...
          '1961-04-01', null, 'month', 'point', '北九州・八幡の社宅2Kへ', '父の転勤で、6歳の春に家族4人で製鉄所の社宅に移りました。台所と二間の2K、風呂は共同棟で、近所と湯の順番を分け合ったものです。廊下に七輪、玄関に自転車。これが記録に残る、私のいちばん古い住まいです。

高度経済成長のただ中で、企業の社宅は住宅不足を補う大きな受け皿でした。**家が会社とともにあった時代**の記憶であり、この年表の出発点になります。', null,
          'verified', null, 'user', 0) returning id)
select 1 from ev;
with ev as (insert into public.events (timeline_id, layer_id, event_date, end_date, date_precision, event_type, title, summary, detail, credibility, credibility_note, origin, position)
  values ((select id from public.timelines where slug = 'personal-moving-history'),
...
with ev as (insert into public.events (timeline_id, layer_id, event_date, end_date, date_precision, event_type, title, summary, detail, credibility, credibility_note, origin, position)
  values ((select id from public.timelines where slug = 'personal-moving-history'),
          (select id from public.layers where timeline_id = (select id from public.timelines where slug = 'personal-moving-history') and name = '引っ越しの記録'),
          '1970-03-01', null, 'month', 'point', '千里ニュータウンの3DKへ', '父の大阪転勤に伴い、15歳の春に千里の公団住宅3DKへ移りました。ダイニングキッチンと洋間、ベランダ、水洗トイレ。八幡の社宅とは別世界で、初めて自分の机を持たせてもらいました。

窓の向こうの丘では、万国博覧会が開かれようとしていました。**2Kから3DKへ**という間取りの変化は、そのまま日本の暮らしの上昇曲線でした。同級生の多くも、同じ春に越してきた転入組だったものです。', null,
          'verified', null, 'user', 3) returning id)
select 1 from ev;
with ev as (insert into public.events (timeline_id, layer_id, event_date, end_date, date_precision, event_type, title, summary, detail, credibility, credibility_note, origin, position)
  values ((select id from public.timelines where slug = 'personal-moving-history'),
...
with ev as (insert into public.events (timeline_id, layer_id, event_date, end_date, date_precision, event_type, title, summary, detail, credibility, credibility_note, origin, position)
  values ((select id from public.timelines where slug = 'personal-moving-history'),
          (select id from public.layers where timeline_id = (select id from public.timelines where slug = 'personal-moving-history') and name = '引っ越しの記録'),
          '1974-04-01', null, 'month', 'point', '上京、風呂なし四畳半の下宿へ', '大学進学で、東京・中野の木造アパートに移りました。四畳半に押し入れ、便所は共同、風呂は銭湯。家賃は月9,000円だったと手帳に残っています。

オイルショック直後の物価高で仕送りは目減りし、銭湯は週3回に節約しました。それでも、初めて自分で選んだ住所でした。団地育ちの目に、木造下宿の路地は古くて新しい東京でした。銭湯の帰りに商店街で買うコロッケが贅沢だったものです。', null,
          'verified', null, 'user', 6) returning id)
select 1 from ev;
with ev as (insert into public.events (timeline_id, layer_id, event_date, end_date, date_precision, event_type, title, summary, detail, credibility, credibility_note, origin, position)
  values ((select id from public.timelines where slug = 'personal-moving-history'),
          (select id from public.layers where timeline_id = (select id from public.timelines where slug = 'personal-moving-history') and name = '引っ越しの記録'),
          '1979-04-01', null, 'month', 'point', '就職、川崎の独身寮6畳へ', 'メーカーに就職し、川崎の独身寮に入りました。6畳一間に作り付けの棚、食堂と大浴場は共同です。同期と廊下で夜通し話したものでした。寮費は安く、月給の多くが貯金に回りました。
...
with ev as (insert into public.events (timeline_id, layer_id, event_date, end_date, date_precision, event_type, title, summary, detail, credibility, credibility_note, origin, position)
  values ((select id from public.timelines where slug = 'personal-moving-history'),
          (select id from public.layers where timeline_id = (select id from public.timelines where slug = 'personal-moving-history') and name = '引っ越しの記録'),
          '1985-06-01', null, 'month', 'point', '中野の賃貸2DKへ', '結婚を機に、学生時代を過ごした中野へ戻り、賃貸マンションの2DKを借りました。家賃は月6万8,000円。あの四畳半の下宿から、歩いて10分の場所でした。

この部屋で長女が生まれ、6年を暮らします。その間に地価は高騰を続け、「買うなら早く」という焦りが世間に満ちていきました。それが次の引っ越しの伏線になるのですが、当時はまだ対岸の火事だと思っていたのです。', null,
          'verified', null, 'user', 9) returning id)
select 1 from ev;
with ev as (insert into public.events (timeline_id, layer_id, event_date, end_date, date_precision, event_type, title, summary, detail, credibility, credibility_note, origin, position)
  values ((select id from public.timelines where slug = 'personal-moving-history'),
...
with ev as (insert into public.events (timeline_id, layer_id, event_date, end_date, date_precision, event_type, title, summary, detail, credibility, credibility_note, origin, position)
  values ((select id from public.timelines where slug = 'personal-moving-history'),
          (select id from public.layers where timeline_id = (select id from public.timelines where slug = 'personal-moving-history') and name = '引っ越しの記録'),
          '1991-02-01', null, 'month', 'point', '通勤90分、埼玉の建売住宅を購入', '埼玉の郊外に、建売の4LDKを買いました。都心まで通勤90分。価格は年収の7倍を超え、頭金は双方の親に頼りました。契約の日の営業マンの「今買わないと一生買えませんよ」という言葉を覚えています。

買った直後に地価は下落へ転じ、資産価値は長く戻りませんでした。それでも庭と子ども部屋のある家は、**遠さと引き換えに手に入れた広さ**でした。「高値づかみ」という言葉は、後に何度も聞くことになります。', null,
          'verified', null, 'user', 11) returning id)
select 1 from ev;
with ev as (insert into public.events (timeline_id, layer_id, event_date, end_date, date_precision, event_type, title, summary, detail, credibility, credibility_note, origin, position)
  values ((select id from public.timelines where slug = 'personal-moving-history'),
...
前年に郊外の家を買った私たちには、他人事ではありませんでした。ただしピークの時期や下落幅は地域と用途で大きく異なり、一つの数字では語れません。確かなのは、「家は買えば得」という常識が終わったことです。', null,
          'disputed', '地価のピーク時期や下落幅は地域・用途により大きく異なり、全国一律の数値としては確定できません。', 'user', 12) returning id)
...
with ev as (insert into public.events (timeline_id, layer_id, event_date, end_date, date_precision, event_type, title, summary, detail, credibility, credibility_note, origin, position)
  values ((select id from public.timelines where slug = 'personal-moving-history'),
          (select id from public.layers where timeline_id = (select id from public.timelines where slug = 'personal-moving-history') and name = '引っ越しの記録'),
          '2001-04-01', '2004-03-31', 'month', 'period', '名古屋へ単身赴任、1Kの3年間', '46歳で名古屋勤務となり、単身赴任の1Kマンションで3年を過ごしました。荷物は段ボール10箱。家族の家と自分の部屋、住まいがふたつに分かれた3年間です。
...
with ev as (insert into public.events (timeline_id, layer_id, event_date, end_date, date_precision, event_type, title, summary, detail, credibility, credibility_note, origin, position)
  values ((select id from public.timelines where slug = 'personal-moving-history'),
          (select id from public.layers where timeline_id = (select id from public.timelines where slug = 'personal-moving-history') and name = '住宅と都市の時代'),
          '2019-04-01', null, 'month', 'point', '空き家846万戸、空き家率13.6%', '平成30年住宅・土地統計調査の結果が公表され、全国の空き家は846万戸、空き家率は13.6%と過去最高を更新しました。

住宅数が世帯数を上回ってから半世紀、量の充足は過剰へと転じたわけです。地方の実家をどうするかという問いは、私を含む同世代の共通の宿題になりました。この年の秋、私も八幡の実家を手放すことになります(家族の節目レイヤー)。', null,
          'verified', null, 'user', 15) returning id)
...
with ev as (insert into public.events (timeline_id, layer_id, event_date, end_date, date_precision, event_type, title, summary, detail, credibility, credibility_note, origin, position)
  values ((select id from public.timelines where slug = 'personal-moving-history'),
          (select id from public.layers where timeline_id = (select id from public.timelines where slug = 'personal-moving-history') and name = '住宅と都市の時代'),
          '2020-07-01', null, 'month', 'point', '東京都が転出超過に', '住民基本台帳の人口移動報告で東京都が転出超過に転じたと報じられ、テレワークの広がりを背景に、都心を離れる動きが注目されました。

ただし月次の速報値で外国人の移動も含まれ、一時的な変化か構造的な変化かは評価が分かれるようです。確かなのは、通勤距離が住まい選びの絶対条件ではなくなり始めたこと。翌年の私たちの住み替えにも、この変化は追い風になりました。', null,
          'unverified', '月次の速報値に基づく報道で、集計範囲(外国人・世帯類型)や期間の取り方により基調の評価が分かれます。', 'user', 17) returning id)
...
with ev as (insert into public.events (timeline_id, layer_id, event_date, end_date, date_precision, event_type, title, summary, detail, credibility, credibility_note, origin, position)
  values ((select id from public.timelines where slug = 'personal-moving-history'),
          (select id from public.layers where timeline_id = (select id from public.timelines where slug = 'personal-moving-history') and name = '引っ越しの記録'),
          '2021-06-01', null, 'month', 'point', '郊外の家を売り、駅前の中古マンションへ', '30年住んだ埼玉の家を売り、駅から徒歩3分の中古マンション2LDKに移りました。荷物は半分に減らし、本と写真だけは全部持ってきました。おそらく、人生最後の引っ越しです。
